...
const AboutPageClient = () => {
  ...
  const coreValues = [
    {
      icon: <RocketIcon className="w-10 h-10 text-purple-500" />,
      title: "Innovation First",
      description: "We constantly explore new horizons and push the boundaries of technology to deliver cutting-edge solutions.",
    },
    {
      icon: <HeartHandshakeIcon className="w-10 h-10 text-purple-500" />,
      title: "Client Partnership",
      description: "Your success is our success. We build strong, collaborative relationships to understand and achieve your goals.",
    },
    {
      icon: <AwardIcon className="w-10 h-10 text-purple-500" />,
      title: "Pursuit of Excellence",
      description: "We are committed to the highest standards of quality, precision, and performance in everything we do.",
    },
  ];
  ...
  const initialImageLoadedState = Array(companyLifeImages.length + 1).fill(false); // +1 for mission-vision
  const [imageLoaded, setImageLoaded] = useState<boolean[]>(initialImageLoadedState);
  const MISSION_VISION_IMG_INDEX = companyLifeImages.length; // Assign a unique index for the mission/vision image
  ...
  return (
    <div className={`bg-gradient-to-br from-purple-950/25 via-neutral-950 to-neutral-950 text-neutral-300 antialiased selection:bg-purple-500 selection:text-white min-h-screen`}>
        ...
        <div className="max-w-4xl 2xl:max-w-5xl mt-30 mx-auto text-center relative z-10">
          ...
          <nav aria-label="Breadcrumb" className="relative z-10 mt-6 sm:mt-8 text-sm md:text-base text-neutral-400">
            <ol className="list-none p-0 inline-flex items-center space-x-1.5 md:space-x-2">
              ...
              <li>
                <span className="text-purple-500/90 font-medium" aria-current="page">About Us</span>
              </li>
            </ol>
          </nav>
      ...
      {/* Content Sections within TracingBeam */}
            ...
            <div className="grid md:grid-cols-2 gap-10 lg:gap-16 xl:gap-20 items-center">
              <div className="order-2 md:order-1">
                <div className="aspect-[16/9] rounded-xl overflow-hidden shadow-2xl relative border border-neutral-800/50 hover:border-purple-600/50 transition-colors duration-300">
                  ...
                  <Image
                    ...
                    alt="ElanTech Mission and Vision"
                    fill
                    sizes="(max-width: 768px) 100vw, 50vw"
                    style={{ objectFit: 'cover' }}
                    quality={80}
                    priority 
                    className={`transition-opacity duration-500 ease-in-out group-hover:scale-105 ${imageLoaded[MISSION_VISION_IMG_INDEX] ? 'opacity-100' : 'opacity-0'}`}
                    onLoad={() => handleImageLoad(MISSION_VISION_IMG_INDEX)}
                  />
                </div>
              </div>
              ...
              <div className="order-1 md:order-2 text-center md:text-left">
                ...
                <p className="text-neutral-300/80 leading-relaxed mb-4 text-base text-justify sm:text-lg">
                  Our mission is to democratize access to advanced AI and software solutions, enabling businesses of all sizes to innovate, automate, and achieve unprecedented growth. We envision a future where technology seamlessly integrates with human potential to solve complex challenges.
                </p>
                <p className="text-neutral-300/80 leading-relaxed text-base sm:text-lg text-justify">
                  We strive to be at the forefront of technological advancement, delivering solutions that are not only intelligent but also ethical, scalable, and user-centric.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-10 lg:gap-16 xl:gap-20">
              <div className="md:w-2/5 text-center md:text-left">
                ...
                <p className="text-neutral-300/80 leading-relaxed text-justify mb-8 sm:mb-10 text-base sm:text-lg">
                  Discover the vibrant culture, collaborative spirit, and exciting opportunities that define working with us.
                  We foster an environment where innovation thrives and every individual can make an impact.
                </p>
                <Link
                  href="/careers"
              ...
              <div className="md:w-3/5 w-full">
                <div className="grid grid-cols-2 grid-rows-auto gap-4 h-auto md:h-[36rem] lg:h-[30rem]">
                  {companyLifeImages.map((src, index) => (
                    <div
                      key={index}
                      className={`relative rounded-lg overflow-hidden ${index === 2 ? 'col-span-2 row-span-1 h-64 md:h-full' : 'col-span-1 row-span-1 h-48 md:h-full'}`}
                    >
                      {!imageLoaded[index] && (
        ...
        <section className={`py-16 sm:py-20 md:py-24 lg:py-28 border-b ${sectionBorderStyle}`}>
          <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16 xl:gap-20">
              ...
              <div className="lg:w-3/5 w-full order-2 lg:order-1 mt-10 lg:mt-0"> 
                <DynamicFocusCards
                  cards={teamFocusCardsData}
                />
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto">
            <div className="flex flex-col items-center gap-10 lg:gap-16 xl:gap-20">
              ...
              <div className="text-center mb-1 md:mb-1">
                ...
                <p className="text-neutral-300/80 leading-relaxed mb-0 text-base text-justify sm:text-lg">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 w-full">
                {coreValues.map((value, index) => (
                  <div
                    key={index}
                    className="bg-neutral-800/50 p-6 rounded-xl shadow-lg text-center transform transition-all hover:scale-105 hover:shadow-purple-500/30"
                  >
