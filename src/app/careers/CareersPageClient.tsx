...
const CareersPageClient = ({
  ...
  const cultureItems: CultureItem[] = [
    ...
    {
      // icon: UsersIcon,
      iconSVG: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 text-purple-500"><path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M12 12.75v-6m0 6h.008v.008H12v-.008Zm0-6v-3.75m0 3.75h.008v.008H12v-.008Zm0 0L9.75 5.25m0 0L12 3m0 0l2.25 2.25M9.75 5.25v1.5_read_less_"</svg>`,
  ...
  return (
     <div className={`bg-gradient-to-br from-purple-950/25 via-neutral-950 to-neutral-950 text-neutral-300 antialiased selection:bg-purple-500 selection:text-white min-h-screen`}>
        ...
        <div className="max-w-4xl 2xl:max-w-5xl mt-30 mx-auto text-center relative z-10">
          ...
          <nav aria-label="Breadcrumb" className="relative z-10 mt-8 sm:mt-10 text-sm md:text-base text-neutral-400">
            <ol className="list-none p-0 inline-flex items-center space-x-1.5 md:space-x-2">
              ...
              <li>
                <span className="text-purple-500/90 font-medium" aria-current="page">Careers</span>
              </li>
            </ol>
          </nav>
          ...
          >
            View Open Roles
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 ml-2 transition-transform duration-300 group-hover:translate-y-0.5">
      ...
      <DynamicTracingBeam className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
              {cultureItems.map((item) => (
                <div key={item.title} className="bg-neutral-900/50 p-6 sm:p-8 rounded-xl border border-neutral-800/60 shadow-lg hover:border-purple-500/50 hover:shadow-purple-500/10 transition-all duration-300 transform hover:-translate-y-1">
                  <div className="flex items-center justify-center mb-5 w-12 h-12 rounded-full bg-purple-500/10 border border-purple-500/30" dangerouslySetInnerHTML={{ __html: item.iconSVG || '' }}>
                    {/* {item.icon && <item.icon className="w-6 h-6 text-purple-500" />} */}
                  </div>
        ...
        {/* Life at ElanTech (Visuals - Placeholder) 
        <section id="life-at-elantech" className={`py-16 sm:py-20 md:py-24 lg:py-28 border-b ${sectionBorderStyle}`}>
            <div className="container mx-auto">
                <div className="text-center mb-12 md:mb-16">
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-neutral-100 mb-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                    {['/images/careers/team-event.jpg', '/images/careers/office-collab.jpg', '/images/careers/remote-setup.jpg', '/images/careers/learning-session.jpg', '/images/careers/project-milestone.jpg', '/images/careers/company-culture.jpg'].map((imgSrc, index) => (
                        <div key={index} className={`relative aspect-video sm:aspect-square rounded-xl overflow-hidden shadow-lg border border-neutral-800/60 group ${index >=3 && 'hidden md:block'} ${index >=4 && 'hidden lg:block'}`}>
                            <Image src={imgSrc} alt={`Life at ElanTech ${index + 1}`} fill style={{objectFit: 'cover'}} className="grayscale group-hover:grayscale-0 transition-all duration-300 transform group-hover:scale-105" />
          ...
          <div className="container mx-auto">
            <div className="grid md:grid-cols-2 gap-12 md:gap-16 lg:gap-20 items-center">
                ...
                <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                  {perks.map((perk) => (
                    <div key={perk.name} className="flex items-center">
                       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 text-purple-500 mr-2.5 shrink-0">
              ...
              <div className="hidden md:block"> 
                <Image
                    src="/growth-mindset.jpg" 
                    alt="Growth and Development at ElanTech"
                    width={500}
                    height={400}
                    style={{objectFit: 'cover'}}
                    className="rounded-xl shadow-xl border border-neutral-800/60"
                />
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto">
            ...
            {jobs && jobs.length > 0 ? (
                ...
                {jobs.map((job, index) => (
                  <Link
                    ...
                    className={`
                        ...
                        hover:bg-purple-600/10 transition-colors duration-300 group
                  ...
                  >
                    <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                      <div className="flex-grow">
                        <h3 className="text-xl sm:text-2xl font-semibold text-neutral-100 group-hover:text-purple-500 transition-colors duration-200 mb-1.5">
                          {job.title}
                        </h3>
                        ...
                        <p className="text-neutral-400 text-sm mt-2 leading-relaxed hidden sm:block">
              ...
              <p className="text-center text-neutral-400 text-lg">
                We currently don&apos;t have any open positions, but we&apos; always interested in hearing from talented individuals.
              </p>
            )}
