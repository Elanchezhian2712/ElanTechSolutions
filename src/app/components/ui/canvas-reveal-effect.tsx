...
const DotMatrix: React.FC<DotMatrixProps> = ({
  ...
  // Prepare colorsArray based on colors length
  ...
  // Compose the shader string with dynamic centering logic inside useMemo
  const fullShader = useMemo(() => {
    return `
...
const ShaderMaterial = ({
  ...
  // Replace lines around 220-221 with proper types

const getUniforms = React.useCallback((): Record<string, THREE.IUniform> => {
