  ...
  return (
    <>
      <footer>
            ...
            <AuroraBackground>
              <div className="md:flex w-full h-full items-center">
                <framerMotion.div
                  ...
                  className="relative flex flex-col gap-3 items-center justify-center 
                    px-6 md:items-start md:px-10 md:w-1/2 md:ml-16 
                    w-full text-center md:text-left pb-2 md:pb-0"
                >
                ...
                {/* Corrected Globe Container */}
                <div className="relative w-full md:w-1/2 flex items-center justify-center min-h-[22rem] sm:min-h-[26rem] lg:min-h-[28rem] mt-8 md:mt-0 overflow-hidden">
                  <Globe />
        ...
        <div className='text-white bg-gradient-to-br from-purple-900/30 via-zinc-950 to-zinc-950'>
          <div className={` ${borderStyle} grid grid-cols-1 md:grid-cols-12 gap-0 py-10 sm:py-12 ${horizontalPadding}`}>
            <div className={`md:col-span-4 lg:col-span-5 md:border-r ${borderStyle} md:pr-6 lg:pr-8 py-4`}>
              <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4 mb-6 items-center justify-center sm:justify-start">
                ...
                <Link href="/" className="flex-shrink-0">
                  <Image src="/logo-elantech.png" alt="Logo Text" width={220} height={50} />
                </Link>
              </div>
              <p className="text-sm sm:text-base text-white/70 leading-relaxed text-justify">
                Elan Tech Solutions transforms ideas into impactful digital experiences — from AI-powered applications to scalable web platforms. We help businesses thrive with intuitive design, DevOps automation, and cutting-edge technology.
              </p>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 py-4 md:pl-6 lg:pl-8">
                ...
                <nav aria-label="Footer Navigation">
                  <ul className="flex flex-wrap justify-center md:justify-start gap-3 sm:gap-6 text-sm sm:text-base text-white">
                    {[
                      ...
                      <li key={href}>
                        <Link href={href} className="hover:text-purple-500 transition-colors">{label}</Link>
                      </li>
                    ))}
                  </ul>
                </nav>
              ...
              {/* Contact Info Cards */}
              <div className={`border-t ${borderStyle} pt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-8 sm:gap-y-10`}>
                {[
                  {
              ...
              <a
                ...
                className={`
                        ...
                        ${index === 2 ? 'sm:col-span-2 lg:col-span-1' : 'sm:col-span-1'} 
                    ...
                    <h4 className="text-base font-semibold text-white mt-3 group-hover:text-gray-100 transition duration-300">{title}</h4>
                    <p className="text-sm text-white/70 group-hover:text-white transition duration-300">{text}</p>
                  </a>
                ))}
              </div>
            </div>
          ...
          {/* Bottom Bar */}
          <div className={`border-t ${borderStyle} mt-0 sm:mt-10 py-6 flex flex-col sm:flex-row justify-between items-center text-xs sm:text-sm text-white/60 ${horizontalPadding}`}>
